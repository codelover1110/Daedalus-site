                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <Link to="/login/" onClick={this.closeMenu} style = {{color:'white'}}>Login
                    ...
                    </ul>
                    {
                      ...
                      >
                         <li>
                          <Link to="/signup/" className="button button-wide-mobile button-sm" style={{color:'black'}} onClick={this.closeMenu}>Sign up</Link>
                        </li>
