      ...
      <React.Fragment>
        ...
        <GenericSection topDivider className="center-content">
          <div className="container">
            ...
            <ButtonGroup>
              <Button color="primary" wideMobile>Learn More</Button>
              <Button color="secondary" wideMobile>Learn More</Button>
            </ButtonGroup>
            <ButtonGroup>
              <Button color="dark" wideMobile>Learn More</Button>
              <Button wideMobile>Learn More</Button>
            </ButtonGroup>
          </div>
        </GenericSection>
            ...
            <form style={formStyle}>
              ...
              <div className="mb-24">
                <Input
                  ...
                  formGroup="desktop"
                  labelHidden
                  value="hello@daedalustrading.tech">
